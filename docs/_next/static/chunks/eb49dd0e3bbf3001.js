(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e) => {
		...
		var t = e.i(4601),
			...
			n = r.default.createContext && r.default.createContext(a),
			o = ['attr', 'size', 'title'];
		function l() {
		...
		function d(e) {
			...
			return void 0 !== n
				? r.default.createElement(n.Consumer, null, (e) => t(e))
				: t(a);
		}
		function u(e) {
			return c({
		...
		let p = () => {
			let {
					...
					update: o,
					remove: l,
				} = (({ databaseName: e = '', storeName: t = '' }) => {
					let [a, n] = (0, r.useState)(null);
					(0, r.useEffect)(() => {
					...
					return {
						...
						list: () =>
							new Promise((e, r) => {
								if (!a) return e([]);
								let n = a.transaction(t, 'readonly').objectStore(t).getAll();
								((n.onsuccess = () => {
									let t = n.result;
									(t.sort(o), e(t));
								}),
									(n.onerror = () =>
										r(Error(n.error?.message || 'Failed to fetch tasks'))));
							}),
						add: (e) =>
							new Promise((r, n) => {
								if (!a) return;
								let o = new Date().toISOString(),
									l = a.transaction(t, 'readwrite');
								(l.objectStore(t).add({ text: e, completed: !1, updatedAt: o }),
									(l.oncomplete = () => r()),
									(l.onerror = () =>
										n(Error(l.error?.message || 'Failed to add task'))));
							}),
						update: (e) =>
							new Promise((r, n) => {
								if (!a) return;
								let o = new Date().toISOString(),
									l = a.transaction(t, 'readwrite');
								(l.objectStore(t).put({ ...e, updatedAt: o }),
									(l.oncomplete = () => r()),
									(l.onerror = () =>
										n(Error(l.error?.message || 'Failed to update task'))));
							}),
						remove: (e) =>
							new Promise((r, n) => {
								if (!a) return;
								...
								(o.objectStore(t).delete(e),
									(o.oncomplete = () => r()),
									(o.onerror = () =>
										n(Error(o.error?.message || 'Failed to delete task'))));
							}),
					};
			...
			let p = async () => {
					c.trim() && (await n(c.trim()), d(''), i(await a()));
				},
				f = async (e) => {
					(await o({ ...e, completed: !e.completed }), i(await a()));
				},
				b = async (e) => {
					(await l(e), i(await a()));
				};
										...
										children: [
											(0, t.jsxs)('div', {
												...
												children: [
													...
													(0, t.jsx)('span', {
														className: `text-lg ${e.completed ? 'text-gray-500 line-through' : ''}`,
														children: e.text,
													}),
												],
											}),
